  ...
  return (
    <section className="border-t border-border py-28 text-center">
      ...
      <p className="mx-auto mt-5 max-w-md text-muted-foreground">
        The first 50 servers to add Nexus get a permanent founder badge, free Nexus Pro for life, and exclusive access to beta commands and features.
      </p>
